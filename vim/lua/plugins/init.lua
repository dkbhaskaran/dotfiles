...
local plugin_list = {
  ...
  -- Another way to incldue a plugin
  ...
  },
  {
    ...
    vim.keymap.set('n', '<leader>th', '<cmd>ToggleTerm direction=horizontal<CR>', { desc = 'Open a horizontal terminal' }),
    vim.keymap.set('n', '<leader>tv', '<cmd>ToggleTerm direction=vertical<CR>', { desc = 'Open a horizontal terminal' }),
  },
} --
--
local lazy_options = {
...
require('lazy').setup(plugin_list, lazy_options)
